Darts is tegenwoordig een erg populair spel. Een speler gooit elke beurt 3 pijlen naar een bord. Dat bord is in sectoren verdeeld die elk een specifieke waarde hebben tussen 1 en 20. Deze punten worden verdubbeld als de pijl in de buitenste rand van de sector (de double ring) terechtkomt, en worden ze verdriedubbeld als de pijl in de ring in het midden van de sector (de triple ring) terechtkomt.  
Ten slotte is er in het midden een kleine rode cirkel (de roos of 'double bull') en daarrond een groene cirkel (de 'single bull'). Die leveren resp. 50 en 25 punten op.  
Dat geeft volgend overzicht:  
  
 ![darts](media/dartsWorp.jpg)
  
Schrijf een functie `dartsWorp` die op basis van de plaats waar de pijl terechtkomt het aantal behaalde punten teruggeeft:  
...
Je functie krijgt dus als invoer een tekst binnen ("BULL", "SBULL", "D20", "T8", "17") en geeft als uitoverwaarde de waarde van de worp terug. Omdat je in sommige gevallen de eerste letter (een "T" of een "D") uit de invoerparameter moet verwijderen krijg je nog wat info cadeau:  
